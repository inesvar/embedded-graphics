...
- [#772](https://github.com/embedded-graphics/embedded-graphics/pull/772) Added feature dotted border (through the `stroke_style` helper), implemented for `Rectangle`.
